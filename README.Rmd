...
dt_events <- events('~/Dropbox/pkg.data/auction_emotions/Raw/session1/ESI-115-02.csv')
dt_emotions <- emotions('~/Dropbox/pkg.data/auction_emotions/Raw/session1/Participant 2_ESI-115-02_Analysis 1_video_20170802_162439_detailed.csv')
dt_payoffs <- payoffs()
...
setkey(dt_events, event_start, event_end)
setkey(dt_emotions, snap_start, snap_end)
